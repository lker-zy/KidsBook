...
public class AppConfig {
    public static final String SEARCH_URL = "http://180.76.176.227/web/search.action";
    ...
    public static final String STORAGE_BASE = "XuewenOnline/KidsBook";
    public static final String CACHE_BASE = STORAGE_BASE + "/cache";
}
