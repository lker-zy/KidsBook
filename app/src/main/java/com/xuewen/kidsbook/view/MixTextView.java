...
public class MixTextView extends RelativeLayout {
    ...
    public MixTextView(Context context, AttributeSet attrs) {
        super(context, attrs);
        ...
        //just for text
        if (mText == null) {
            mText = getResources().getString(R.string.load);
        }
