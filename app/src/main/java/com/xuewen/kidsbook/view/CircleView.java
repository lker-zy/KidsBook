...
public class CircleView extends ViewGroup {
    ...
    public void setMenuItemIconsAndTexts(int[] resIds, String[] texts) {
        ...
        */
        ...
        // 初始化mMenuCount
        int menuItemCount = resIds == null ? texts.length : resIds.length;

        if (resIds != null && texts != null) {
            menuItemCount = Math.min(resIds.length, texts.length);
        }
     ...
     * 添加菜单项
     */
    public void addMenuItem(int resId, String text) {
        LayoutInflater mInflater = LayoutInflater.from(getContext());
        ...
        if (iv != null && resId > 0) {
            ...
            iv.setOnClickListener(new OnClickListener() {
                ...
                @Override
                public void onClick(View v) {
                    int pos = mMenuItemCount;

                    if (mOnMenuItemClickListener != null) {
                        mOnMenuItemClickListener.itemClick(v, pos);
                    }
                }
            });
        }
        ...
        mItemImgs[mMenuItemCount] = resId;
        mItemTexts[mMenuItemCount] = text;
        mMenuItemCount++;
    }
